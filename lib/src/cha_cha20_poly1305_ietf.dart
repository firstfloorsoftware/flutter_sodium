...
class ChaCha20Poly1305Ietf {
  ...
  static Future<String> decrypt(Uint8List cipherText, String additionalData,
    ...
    final message = await Sodium.cryptoAeadChacha20poly1305IetfDecrypt(
        null,
        cipherText,
        additionalData == null ? null : utf8.encode(additionalData),
        nonce,
  ...
  static Future<DetachedCipher> encryptDetached(String value,
    ...
    var map = await Sodium.cryptoAeadChacha20poly1305IetfEncryptDetached(
        utf8.encode(value),
        additionalData == null ? null : utf8.encode(additionalData),
        null,
        nonce,
  ...
  static Future<String> decryptDetached(DetachedCipher cipher,
      String additionalData, Uint8List nonce, Uint8List key) async {
    final message = await Sodium.cryptoAeadChacha20poly1305IetfDecryptDetached(
        null,
        cipher.cipher,
        cipher.mac,
        additionalData == null ? null : utf8.encode(additionalData),
