...
class CryptoAuth {
  ...
  static Future<Uint8List> compute(String value, Uint8List key) async {
    assert(value != null);
    return Sodium.cryptoAuth(utf8.encode(value), key);
  }
  ...
  static Future<bool> verify(Uint8List tag, String value, Uint8List key) async {
    assert(value != null);
    return Sodium.cryptoAuthVerify(tag, utf8.encode(value), key);
  }
