...
final int Function() crypto_box_seedbytes =
    lookup_sizet("crypto_box_seedbytes");

final int Function() crypto_box_publickeybytes =
    lookup_sizet("crypto_box_publickeybytes");

final int Function() crypto_box_secretkeybytes =
    lookup_sizet("crypto_box_secretkeybytes");

final int Function() crypto_box_noncebytes =
    lookup_sizet("crypto_box_noncebytes");

final int Function() crypto_box_macbytes = lookup_sizet("crypto_box_macbytes");

final int Function() crypto_box_messagebytes_max =
    lookup_sizet("crypto_box_messagebytes_max");

final int Function() crypto_box_sealbytes =
    lookup_sizet("crypto_box_sealbytes");

final int Function() crypto_box_beforenmbytes =
    lookup_sizet("crypto_box_beforenmbytes");
...
final int Function(Pointer<Uint8> pk, Pointer<Uint8> sk) crypto_box_keypair =
    libsodium
...
final int Function(Pointer<Uint8> c, Pointer<Uint8> m, int mlen,
    ...
    libsodium
        .lookup<
            NativeFunction<
                Int32 Function(Pointer<Uint8>, Pointer<Uint8>, Uint64,
                    Pointer<Uint8>, Pointer<Uint8>)>>("crypto_box_easy_afternm")
        .asFunction();
